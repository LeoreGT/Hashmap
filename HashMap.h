 ...
 * @details zero capacity will be rounded to 1
 */
 ...
 * @param[in] _searchKey - key to serve as index to locate _value
 * @param[out] _pValue - pointer to variable that will get the value if found.
 * @return Success indicator
 * @retval  MAP_SUCCESS	on success
 * @retval  MAP_KEY_NULL_ERROR
